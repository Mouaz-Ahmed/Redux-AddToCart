...
const Navbar = () => {
    const list = useSelector(state => state.cart.list) // toolkit se dekhea
            ...
            <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                ...
                <div className="offcanvas-body">
                    {list?.length > 0 ? list?.map((item, key) => (
                        <div className='cartItem d-flex justify-content-between'  key={key}>
                            <div className='cartImage'>
                                <img src={item.image} />
                            </div>
                            <div className=''>
                                <div className='cartImage'>{item.title}</div>
                                <div className='cartImage'>{item.price}</div>
                            </div>
                            <div>
